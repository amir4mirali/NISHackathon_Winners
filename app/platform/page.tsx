...
const roleButtons: { role: UserRole; label: string }[] = [
  { role: "resident", label: "Login as Resident" },
  { role: "developer", label: "Login as Developer" },
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="text-sm text-[color:var(--muted)]">
              Active role: <span className="font-semibold capitalize">{role}</span> ({currentUser.name})
            </p>
          </div>
